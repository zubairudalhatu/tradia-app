      ...
      <section className="rounded-tradia border border-slate-200 bg-white p-8 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-6 border-b border-slate-200 pb-6">
          ...
          <div className="text-left sm:text-right">
            <p className="text-sm font-extrabold uppercase text-ember">Admin Payment Receipt</p>
        ...
        {payment.subscription ? (
          <div className="mt-8 rounded-tradia bg-slate-50 p-5">
        ...
        <p className="mt-8 border-t border-slate-200 pt-5 text-xs leading-5 text-slate-500">
          This admin receipt confirms a successful payment recorded by Tradia. Use the provider reference for payment support and reconciliation.
        </p>
      </section>
    </main>
  );
...
function ReceiptField({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-tradia border border-slate-200 p-4">
